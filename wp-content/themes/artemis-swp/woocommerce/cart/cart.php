				...
				if ( $_product && $_product->exists() && $cart_item['quantity'] > 0 && apply_filters( 'woocommerce_cart_item_visible', true, $cart_item, $cart_item_key ) ) {
					...
					<td class="product-name" data-title="<?php esc_html_e( 'Product', 'artemis-swp' ); ?>">
						...
						do_action( 'woocommerce_after_cart_item_name', $cart_item, $cart_item_key );
							...
							echo wp_kses_post( apply_filters( 'woocommerce_cart_item_backorder_notification', '<p class="backorder_notification">' . esc_html__( 'Available on backorder', 'artemis-swp' ) . '</p>' ) );
							}
						?>
					</td>

						<td class="product-price" data-title="<?php esc_attr_e( 'Price', 'artemis-swp' ); ?>">
						<?php
							echo apply_filters( 'woocommerce_cart_item_price', WC()->cart->get_product_price( $_product ), $cart_item, $cart_item_key );
						?>
					</td>

						<td class="product-quantity" data-title="<?php esc_attr_e( 'Quantity', 'artemis-swp' ); ?>">
						<?php
						...
						<td class="product-subtotal" data-title="<?php esc_attr_e( 'Total', 'artemis-swp' ); ?>">
						<?php
