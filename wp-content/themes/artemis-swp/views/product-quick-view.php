...
{
	$image = $variation_product->get_image( apply_filters( 'single_product_large_thumbnail_size', 'shop_single' ) );
	$props = wc_get_product_attachment_props( get_post_thumbnail_id($variation_post), $variation_post );
	$postId=$variation_post->ID;
}
else
{
...
<div <?php post_class(); ?>>
	...
	<div class="summary entry-summary at_qv_product_details">
		<a href="<?php echo esc_url( get_permalink($postId)) ?>"><?php woocommerce_template_single_title() ?></a>
