...
function ARTEMIS_SWP_has_megamenu() {
	...
	$menus_with_mega_menu = array("centered_menu", "classic_menu", "classic_double_menu", "classic_double_menu_logo_center", "classic_double_menu_center", "split_menu", "split_menu_creative");
...
function ARTEMIS_SWP_get_number_of_rows() {
...
function ARTEMIS_SWP_change_shop_page_sidebar() {
	$change_sidebar = ARTEMIS_SWP_get_theme_option('artemis_theme_shop_options', 'lc_shop_change_shop_page_sidebar');

	if (empty($change_sidebar)) {
		return false;
	}

	return "yes" == $change_sidebar ? true : false;

}

function ARTEMIS_SWP_choose_registration_password_strength() {
	...
	// substract 1, because the strenght levels are from 0->3
	return ($password_strength-1);
}

function ARTEMIS_SWP_is_mobile_toggle_sidebar_enabled() {
	$enabled = ARTEMIS_SWP_get_theme_option( 'artemis_theme_shop_options', 'lc_shop_show_mobile_toggle_sidebar' );
	if ( empty( $enabled ) ) {
		return false;
	}
	return $enabled == 'yes';
