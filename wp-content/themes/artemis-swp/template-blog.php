	...
	if ($wp_query->have_posts()) {
		...
		<div class="page_navigation">
			<span class="page_nav_item">
				<?php next_posts_link('<i class="fa fa-long-arrow-left" aria-hidden="true"></i> ' . esc_html__("Older posts", "artemis-swp")); ?>
			</span>
			<span class="page_nav_item">
				<?php previous_posts_link(esc_html__("Newer posts", "artemis-swp") . ' <i class="fa fa-long-arrow-right" aria-hidden="true"></i>'); ?>
			</span>
		</div>		
		<?php
	} else { ?>
