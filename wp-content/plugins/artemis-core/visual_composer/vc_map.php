		...
		vc_map( array(
			  ...
			  "params" => array(
				...
				array(
					...
					"value" => "",
					"description" => esc_html__("View all text message. If empty and URL inserted, default value is: View All Images", "artemis-swp-core")
				),
				array(
					"type" => "textfield",
					"class" => "",
		...
		vc_map( array(
			  ...
			  "params" => array(
				...
				array(
					...
					"param_name" => "heading",
					"value" => "RlJFRSA8c3Ryb25nPlNISVBQSU5HPC9zdHJvbmc+",
				...
				array(
					...
					"value" => "Q29uc2VjdGV0dXIgYWRpcGlzY2luZyBlbGl0IEN1cmFiaXR1ciBzZWQgdHVycGlzIGZldWdpYXQsIG1vbGxpcyBmZWxpcyB2ZWwu",
		...
		vc_map( array(
			  ...
			  "params" => array(
				...
				array(
					...
					"value" => "PHN0cm9uZz5BcnRlbWlzPC9zdHJvbmc+PGJyPnNpbmNlIDE5ODk=",
		...
		vc_map(array(
			  ...
			  "params" => array(
				...
				array(
					...
					"value"		=> "Q3JlYXRpdmUgd2l0aCBjb21mb3J0IGluIG1pbmQ",
		...
		vc_map(array(
			  ...
			  "params" => array(
				...
				array(
					...
					"value" => "https://youtu.be/eIkN3wA5Ffg",
		...
		vc_map(array(
			  ...
			  "params" => array(
				...
				array(
					"type" => "dropdown",
					"class" => "",
					"heading" => esc_html__( "Type Of Products", "artemis-swp-core"),
					"param_name" => "type_of_products",
					"value"		=> array(
						"Best Total Sales" => "best",
									"Featured" => "featured",
									"Select Category" => "category",
								),
					"description" => esc_html__("Choose the selecting criteria", "artemis-swp-core")
				),
				array(
						...
						"value" => "",
						"description" => esc_html__("Choose a product category.", "artemis-swp-core"),
						'dependency' => array(
							'element' => 'type_of_products',
							'value'   => 'category'
						),
					),
				array(
				...
				array("type" => "textfield",
					"class" => "",
					"heading" => esc_html__( "Background Text", "artemis-swp-core"),
					"param_name" => "background_text",
					"value" => "Best products",
					"description" => esc_html__("Text shown in background", "artemis-swp-core")
				)
			  )
		));
	}
			...
			array(
				...
				'params'   => array(
					...
					array(
						...
						'value'       => 'fa fa-truck', // default value to backend editor admin_label
						'settings'    => array(
							'emptyIcon'    => false,
		...
		vc_map( array(
			...
			"params"	=> array(
				...
				array(
					"type" => "textarea_html",
					"class" => "",
					"heading" => esc_html__("Consent message", "artemis-swp-core"),
					"param_name" => "content",
					"value" => "This form collects your name and email so that we can add you to our newsletter list for awesome news. Check our our privacy policy for more details on how we protect and manage your data.",
					"description" => esc_html__("Consent message to be accepted by the user. Can contain link to the privacy policy.", "artemis-swp-core")
				)
			)
		));
	}
